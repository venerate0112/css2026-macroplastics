...
with open("PDFs/Report_Presentation.pdf", "rb") as file:
...
with open("PDFs/Research_study.pdf", "rb") as file:
    st.sidebar.download_button(
...
# --- METHODS ---
    ...
    st.image("images/study_Area_Map.png", use_container_width=True)
...
# --- RESULTS ---
    ...
    st.image("images/PCA_Biplot.png", use_container_width=True)
    st.markdown("""
    ...
    *4,157 individuals* were collected in S1 and *604 individuals* in S2.
    ...
    try:
        df_macro = pd.read_excel("Excel data/Macroinvertebrates_Season1_2.xlsx")
        df_water = pd.read_excel("Excel data/Water_Parameters_Season1_2.xlsx")
        df_div = pd.read_excel("Excel data/Diversity_Indices.xlsx")

        st.write("### Macroinvertebrates Data")
        st.dataframe(df_macro, use_container_width=True)
        st.download_button(
            label="Download Macroinvertebrates Data",
            data=open("Excel data/Macroinvertebrates_Season1_2.xlsx", "rb").read(),
        ...
        st.download_button(
            ...
            data=open("Excel data/Water_Parameters_Season1_2.xlsx", "rb").read(),
        ...
        st.download_button(
            ...
            data=open("Excel data/Diversity_Indices.xlsx", "rb").read(),
...
# --- ACKNOWLEDGMENTS ---
    ...
    col1.image("images/UMP_Logo.png", caption="University of Mpumalanga", use_container_width=True)
    col2.image("images/NRF_Logo.png", caption="National Research Foundation", use_container_width=True)
